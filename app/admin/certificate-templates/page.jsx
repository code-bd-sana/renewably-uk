...
export default function CertificateTemplate() {
  return (
    <div className='min-h-screen bg-gray-100 p-4 md:p-6'>
      <div className='mx-4 md:mx-8 lg:mx-44 bg-white rounded-lg shadow-md'>
        {/* Page Title */}
        <div className='px-4 md:px-6 lg:px-8 py-4 md:py-5 border-b border-gray-200'>
        ...
        <div className='px-4 md:px-6 lg:px-8 py-6 md:py-8 bg-gray-50 border-b border-gray-200'>
          <div className='flex flex-col md:flex-row justify-between items-start md:items-center gap-4'>
            <div className='order-2 md:order-1'>
              <h1 className='text-xl md:text-2xl lg:text-3xl font-semibold text-[#0F47A8] mb-2'>
                Insurance Backed Guarantee
              </h1>
              <p className='text-xs md:text-sm text-[#0F47A8]'>
        ...
        <div className='px-4 md:px-6 lg:px-8 py-6 md:py-8'>
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-5 mb-6 md:mb-8'>
            ...
            <div className='bg-gray-50 p-4 md:p-5 rounded-md'>
              ...
              <div className='flex items-start gap-2 text-sm text-gray-600'>
                ...
                <span className='text-xs md:text-sm'>The Mill Suite, Hardmans Business Centre</span>
              </div>
            </div>
            ...
            <div className='bg-gray-50 p-4 md:p-5 rounded-md'>
              ...
              <div className='flex items-start gap-2 text-sm text-gray-600'>
                ...
                <span className='text-xs md:text-sm'>2464 Royal Ln. Mesa, New Jersey 45463</span>
              </div>
            </div>
          </div>
          ...
          <div className='bg-gray-50 p-4 md:p-5 rounded-md mb-4 md:mb-5'>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-5'>
              ...
              <div>
                ...
                <p className='text-xl md:text-2xl font-semibold text-gray-800'>£19.04</p>
                <p className='text-xs text-gray-400'>
          ...
          <div className='bg-[#FFFBEF] rounded-2xl p-3 md:p-4 mb-4 md:mb-5'>
            <div className='mb-3'>
              ...
              <a href='#' className='text-xs text-[#0F47A8] hover:underline break-all'>
