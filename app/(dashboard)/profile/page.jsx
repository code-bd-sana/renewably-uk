...
import { CheckCircle, Eye, EyeOff, Lock, FileText, Download, X } from "lucide-react";
import { useEffect, useState } from "react";
import toast, { Toaster } from "react-hot-toast";
          ...
          <div className="bg-white rounded-lg shadow-xl max-w-4xl w-full max-h-[90vh] overflow-hidden">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">
                    {selectedDocument.category} • {formatDate(selectedDocument.createdAt)}
                  </p>
                </div>
              </div>
            ...
            <div className="p-6 overflow-y-auto max-h-[70vh]">
              ...
              <div className="border-t border-gray-200 pt-6">
                <h4 className="text-sm font-medium text-gray-700 mb-3">Document</h4>
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <p className="font-medium text-gray-900">
                          {selectedDocument.ducoment?.split('/').pop() || "document"}
                        </p>
