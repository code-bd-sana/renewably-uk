...
//         setStats(prev => ({ ...prev, editRequests: Math.max(0, prev.editRequests - 1) }));
...
//                       Submitted by: {selectedRequest.contractor?.name} ({selectedRequest.contractor?.companyName})
//                     </p>
//                   </div>
//                   <button
...
//                   <span className={`px-3 py-1 rounded-full text-sm font-medium ${selectedRequest.requestType === 'edit'
//                     ? 'bg-blue-100 text-blue-800'
//                     : 'bg-red-100 text-red-800'
//                     }`}>
//                     {selectedRequest.requestType === 'edit' ? '📝 Edit Request' : '❌ Cancellation Request'}
//                   </span>
...
//                       <p className="font-medium">{selectedRequest.policyHolderName}</p>
//                     </div>
//                     <div>
//                       <p className="text-sm text-gray-500">Contractor</p>
//                       <p className="font-medium">{selectedRequest.contractor?.name}</p>
...
//                       <p className="font-medium">{selectedRequest.contractor?.email}</p>
//                     </div>
//                     <div>
...
//                 {selectedRequest.requestType === 'edit' && selectedRequest.changes && (
//                   <div className="mb-6">
//                     <h3 className="text-lg font-semibold text-gray-800 mb-3">Requested Changes</h3>
//                     <div className="bg-gray-50 p-4 rounded-lg">
//                       <table className="w-full">
//                         <thead>
//                           <tr className="border-b">
//                             <th className="text-left py-2 text-sm font-medium text-gray-700">Field</th>
//                             <th className="text-left py-2 text-sm font-medium text-gray-700">Current Value</th>
//                             <th className="text-left py-2 text-sm font-medium text-gray-700">Requested Change</th>
//                           </tr>
//                         </thead>
//                         <tbody>
//                           {Object.entries(selectedRequest.changes).map(([field, newValue]) => (
//                             <tr key={field} className="border-b">
//                               <td className="py-2 text-sm capitalize">{field.replace(/([A-Z])/g, ' $1')}</td>
//                               <td className="py-2 text-sm text-gray-600">
//                                 {/* You would need to get current values from database */}
//                                 Current value
//                               </td>
//                               <td className="py-2 text-sm font-medium text-blue-600">{newValue}</td>
//                             </tr>
//                           ))}
//                         </tbody>
//                       </table>
...
//                     These notes will be visible to the contractor after decision.
//                   </p>
//                 </div>
...
//                       </td>
//                       <td className="px-6 py-4 whitespace-nowrap">
//                         <span className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${request.requestType === 'edit'
//                           ? 'bg-blue-100 text-blue-800'
//                           : 'bg-red-100 text-red-800'
//                           }`}>
//                           {request.requestType === 'edit' ? 'Edit Request' : 'Cancel Request'}
//                         </span>
//                         {request.reason && (
//                           <div className="text-xs text-gray-500 mt-1 max-w-xs truncate" title={request.reason}>
