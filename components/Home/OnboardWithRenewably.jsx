    ...
    <section className="w-full bg-white py-[120px]">
      <div className="max-w-[1200px] mx-auto px-4">
        ...
        >
          ...
          <p className="text-[14px] text-[#6B7280] max-w-[520px] mx-auto leading-[1.6]">
            The first one stop solution for all your renewable energy industry
            requirements. Onboard today and become compliant and protected
          </p>
        </motion.div>

        {/* ================= DESKTOP (LG+) ================= */}
        <div className="relative hidden xl:grid grid-cols-[1fr_80px_1fr] gap-y-[64px]">
