      ...
      <div className='max-w-[1200px] mx-auto px-4'>
        ...
        <div className='text-center mb-[72px]'>
          ...
          <p className='text-[14px] leading-[1.6] text-[#6B7280] max-w-[560px] mx-auto'>
            Supporting the Renewable Energy Sectors and the UK&apos;s commitment
            to Net Zero
          </p>
        </div>

        {/* Content */}
        <div className='grid grid-cols-1 md:grid-cols-[1fr_1fr] gap-[96px] items-start'>
          {/* LEFT SIDE */}
          <div>
            ...
            <div className='flex flex-col gap-[14px]'>
              {[
                ...
                <div key={i}>
                  ...
                  {i !== 2 && <div className='w-full h-[1px] bg-[#E5E7EB]' />}
                </div>
              ))}
            </div>
          </div>
