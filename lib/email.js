...
export async function sendCertificateEmail(
  ...
  try {
    ...
    const mailOptions = {
      ...
      to: toEmail,
      subject: `Your Insurance Certificates (${totalProducts} certificates) - Policy ${policyNumber}`,
      html: `
        <!DOCTYPE html>
        <html>
        <head>
        ...
        <body>
          <div class="container">
            <div class="header">
              ...
              <p style="margin: 10px 0 0; opacity: 0.9;">${totalProducts} Certificate(s) Attached</p>
            </div>
            <div class="content">
...
${pdfAttachments.map((att, index) => `${index + 1}. ${att.filename}${att.productType ? ` (${att.productType})` : ""}`).join("\n")}
